...
function Panel({ title, subtitle, icon, linkTo, linkLabel, children }: PanelProps) {
  const navigate = useNavigate();
  return (
    <div style={{ background: '#fff', borderRadius: 12, padding: 24, boxShadow: '0 1px 8px rgba(0,0,0,0.08)', display: 'flex', flexDirection: 'column' }}>
      ...
      {!loading && (
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 20, marginBottom: 24 }}>
            ...
            <Panel title="Revenue Trend" subtitle="Last 6 months · $M" icon="📄" linkTo="/pl" linkLabel="P&L">
            ...
            {/* Expenses panel */}
            <Panel title="Budget vs Actual" subtitle="By category · $M" icon="💸" linkTo="/budgeting" linkLabel="Budgets">
              <ResponsiveContainer width="100%" height={200}>
            ...
            {/* Investments panel */}
            <Panel title="Investment Portfolio" subtitle="By asset class" icon="💹" linkTo="/investments" linkLabel="Portfolio">
              <ResponsiveContainer width="100%" height={200}>
                <PieChart>
