  ...
  return (
    <div className="page-content">
      <div style={{ marginBottom: 16 }}>
        <div style={{ fontSize: 22, fontWeight: 700 }}>Trial Balance</div>
        <div style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 2 }}>
          All accounts · Debit, Credit, Net Balance per entity
        </div>
      </div>
      ...
      <div className="card" style={{ marginBottom: 16, padding: '12px 16px' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 20, alignItems: 'flex-start' }}>
          ...
          {/* Category */}
          <div>
            <div style={{ fontSize: 10, color: 'var(--color-text-muted)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Account Category</div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
          ...
          {/* Search */}
          <div>
            <div style={{ fontSize: 10, color: 'var(--color-text-muted)', marginBottom: 6, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Search</div>
            <input
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              placeholder="Account no / name…"
              style={{ padding: '4px 10px', borderRadius: 6, border: '1px solid var(--color-border)', background: 'var(--color-surface)', color: 'inherit', fontSize: 12, width: 200 }}
            />
          </div>
        </div>
      </div>
              ...
              <tbody>
                ...
                {rows.length > 0 && (
                  <tr style={{ background: 'rgba(59,130,246,0.12)', borderTop: '2px solid var(--color-border)', fontWeight: 700 }}>
                    ...
                    <td style={{ padding: '8px 12px', textAlign: 'right', color: (summary?.net_balance ?? 0) < 0 ? '#ef4444' : '#10b981' }}>
