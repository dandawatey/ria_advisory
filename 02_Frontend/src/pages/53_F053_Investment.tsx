        ...
        <div style={{ width: 220, flexShrink: 0, alignSelf: 'start', position: 'sticky', top: 16 }}>
          <div className="card">
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ fontSize: 11, fontWeight: 600, color: '#6b7280', textTransform: 'uppercase', marginBottom: 6 }}>Status</div>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4 }}>
                {['', 'active', 'matured', 'divested'].map(s => (
                  <button key={s} style={chip(statusFilter === s)} onClick={() => setStatus(s)}>
